    ...
    <div className="home">
      ...
      <div className="Page">
        ...
        <p id = "commentAs">Comment as <Link to ={`/profile`} style = {{textDecoration: 'none'}}>userName(fill in)</Link> </p>  
          <form encType="text/plain" method="post" id = "commentForm">
          <textarea placeholder="What are your thoughts?" className="commmentBox">
          </textarea>
        ...
        {comments.map((comment, index) => {
          return <Comment key = {index} item={comment} />;
        })}
        </div>
      </div>
  </div>
